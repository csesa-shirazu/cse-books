                                    ...
                                    <div class="hovereffect">
                                        ...
                                        <div class="overlay"  style="color : blue">
                                            ...
                                            @if ($book->availability == 1)
                                                ...
                                                <a href="{{ route('pages.singlebook', $book->slug) }}"><h2 style="background-color: #1b4b72" class="well well-sm">رزروش کن</h2></a>
                                            @else
                                                <h2 style="background-color: yellow; color:black" class="well well-sm">وضعیت : رزرو</h2>
                                                <a href="{{ route('pages.singlebook', $book->slug) }}"><h2 style="background-color: #1b4b72" class="well well-sm">مشاهده اطلاعات</h2></a>
